...
import net.fabricmc.wynnqol.Publicized.Events.Chat.OnChatHudMouseClick;
import net.fabricmc.wynnqol.Publicized.Events.Chat.OnRenderChatHud;
import net.fabricmc.wynnqol.Publicized.Utils.ChatUtils;
import net.fabricmc.wynnqol.Publicized.Utils.RenderUtils;
